...
countNoOfOccurrences = """
            You are an expert content moderator, and your task is to count the exact occurrences of cuss words or slang words or abusive words or swear word or derogatory remarks targeting specific sections of society or religion, or derogatory remarks related to the Army, Navy, Air Force, or national flag in the given text. Your goal is to accurately count the instances of such content and provide the information in JSON format. 
            Examples of some cuss words = ["गांडू","चूतिया","भेनचोद","fuck", "shit", "fucking", "asshole","रंडीबाजी","चोदे",]
                ...
                "derogatory_remarks_on_air_force": <count_of_air_force_mentions>,
                "derogatory_remarks_on_national_flag": <count_of_national_flag_mentions>,
                "cuss_word_names": [<all correct cuss words found>],
                }"""

# "derogatory_remarks_sentences"[<derogatory_remarks sentences i]
